...
- **主戦場は公開リプ**（③/①）。冷たいDMは反応率が低い
- **1日 5〜15 フォロー / リプ＋DM合計最大5通** まで
- DMは **相手が先に反応した人だけ**
- ①は **問いのみ**（URL・製品名なし）。②は **2往復後** で無料プレビューへ
- テンプレ一括送信禁止
- 製品URLは会話後に `https://get-kairos.online/invite?ref=...`（または `KAIROS_OWNER_REF` 付き）
- 体験捏造禁止。情景・問い・感情の型で人間味を出す
