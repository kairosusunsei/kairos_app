 ...
 */
const SUPPORTED_LOCALES = ['ja', 'en', 'es', 'fr', 'de', 'it', 'pt'];
...
const STRIPE_CHECKOUT_LOCALES = new Set(['ja', 'en', 'es', 'fr', 'de', 'it', 'pt']);
...
const WARM_FALLBACK = {
  ...
  it: {
    thoughtResonanceVector:
      'Il tuo ritmo interiore si allinea a un cammino sereno e luminoso verso l’avanti.',
    mindTuning:
      'Fai un respiro profondo e sciogli le spalle. Una dolce svolta sta già nascendo dentro di te.',
    deepSynchronicity:
      'Ogni coincidenza significativa che noti è la tua mente che riconosce un bello schema di connessione.',
  },
  pt: {
    thoughtResonanceVector:
      'Seu ritmo interior se alinha com um caminho sereno e luminoso para a frente.',
    mindTuning:
      'Respire fundo e relaxe os ombros. Um ponto de virada suave já está nascendo em você.',
    deepSynchronicity:
      'Cada coincidência significativa que você nota é sua mente reconhecendo um belo padrão de conexão.',
  },
};
